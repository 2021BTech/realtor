...
//img
import Up from "../assets/home.svg";
//state
    ...
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto ">
        ...
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src={Up} alt="key" className="w-full rounded-2xl" />
        </div>
        {/* form div */}
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
          <form onSubmit={onSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="w-full bg-slate text-white px-7 py-3 text-sm font-bold uppercase rounded-full border-b-2 shadow-slate shadow-md hover:bg-slate transition duration-150 ease-in-out hover:shadow-lg active:bg-slate-800 flex items-center justify-center gap-4"
              >
                Register
                <FaRegRegistered />
              </button>
